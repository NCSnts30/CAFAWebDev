        ...
        <div className="overlap-4">
          ...
          <div className="news-3">
            ...
            <p className="text-wrapper-4">
              ...
              Competitions (AAADEC) has been officially moved to June 29 and 30
              due to the financial difficulties that we ran into. We would like
              to apologize for any inconveniences that the unexpected scheduling
              modifications...
            </p>
          ...
          <div className="news-5">
            ...
            <p className="text-wrapper-6">
              Counting the Days Till the Big Day! Save the date and prepare to
              be enthralled as “KULTURA SA TELA: Philippine Culture Through
              Fashion redefines the essence of style and culture. Dont miss this
              extraordinary event that will ignite your senses and leave you
              inspired...
            </p>
